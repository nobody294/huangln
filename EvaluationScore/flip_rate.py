...
variant_csvs = {
    ...
    # "combine_negation_opposite": "data/combine_negation_opposite_CI_4B.csv",
    # "combine_negation_active_passive": "data/combine_negation_active_passive_CI_4B.csv",
    # "combine_negation_it-clefts": "data/combine_negation_it-clefts_CI_4B.csv",
    # "combine_negation_wh-clefts": "data/combine_negation_wh-clefts_CI_4B.csv",
    # "combine_opposite_active_passive": "data/combine_opposite_active_passive_CI_4B.csv",
    "combine_opposite_it-clefts": "data/combine_opposite_it-clefts_CI_4B.csv",
    "combine_opposite_wh-clefts": "data/combine_opposite_wh-clefts_CI_4B.csv",
}
...
same_side_flip = {"negation", "opposite", "combine_negation_active_passive", "combine_negation_it-clefts", "combine_negation_wh-clefts", "combine_opposite_active_passive", "combine_opposite_it-clefts", "combine_opposite_wh-clefts"}
