...
if __name__ == "__main__":
    # run(input_csv="data/original_responses_4B_1.csv", output_csv="data/original_CI_4B_1.csv")
    ...
    # run(input_csv="data/negation_responses_4B_1.csv", output_csv="data/negation_CI_4B_1.csv")
