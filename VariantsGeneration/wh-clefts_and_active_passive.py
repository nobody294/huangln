...
output_csv_path    = "data/combine_wh-clefts_active_passive_variants.csv"

model_name = "Qwen/Qwen3-8B"

SYSTEM_PROMPT = (
    "You are a controlled text rewriter for logical variants of short English statements. "
    "You will be given a BASE statement, its WH-CLEFTS variant, and its ACTIVE/PASSIVE CONVERSION variant. "
...
BUILTIN_FEWSHOTS = [
    {
        ...
        "combine variant": "What should be provided to unemployed workers by the state is stronger financial support.",
    },
    {
        ...
        "combine variant": "What should be regorously punished by the EU is Member States that violate the EU deficit rules.",
    },
    {
        ...
        "combine variant": "What the government should tax more heavily are bank and stock market gains.",
    },
    {
        ...
        "combine variant": "What should be allowed to be cast by EU citizens in European Parliament elections is a vote for a party or candidate from any other Member State.",
    },
    {
    ...
    },
    {
        ...
        "combine variant": "What the government is to welcome is the legalisation of the personal use of soft drugs.",
    },
]
...
def build_user_prompt(base: str, wh: str, actpas: str, fewshots_text: str) -> str:
    schema = """{
    ...
    return f"""Task: Construct a COMBINE variant from a base, a wh-clefts variant, and an active/passive variant.
...
def run():
    ...
    for i, row in merged.iterrows():
        ...
        user_prompt = build_user_prompt(base_str, wh_str, actpas_str, fewshots_text)
