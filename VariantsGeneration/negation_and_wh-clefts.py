...
output_csv_path    = "data/combine_negation_wh-clefts_variants.csv"

model_name = "Qwen/Qwen3-8B"

SYSTEM_PROMPT = (
    "You are a controlled text rewriter for logical variants of short English statements. "
    "You will be given a BASE statement, its NEGATION variant, and its WH-CLEFTS variant. "
...
BUILTIN_FEWSHOTS = [
    {
        ...
        "combine variant": "What the state should not provide to unemployed workers is stronger financial support.",
    },
    {
        ...
        "combine variant": "What the EU should not rigorously punish are Member States that violate the EU deficit rules.",
    },
    {
        ...
        "combine variant": "What should not be taxed more heavily are bank and stock market gains.",
    },
    {
        ...
        "combine variant": "What EU citizens should not be allowed to cast in European Parliament elections is a vote for a party or candidate from any other Member State.",
    },
    {
        ...
        "combine variant": "What is not a good thing is the legalisation of same sex marriages.",
    },
    {
        ...
        "combine variant": "What is not to be welcomed is the legalisation of the personal use of soft drugs.",
    },
]
...
def build_user_prompt(base: str, neg: str, wh: str, fewshots_text: str) -> str:
    schema = """{
    ...
    return f"""Task: Construct a COMBINE variant from a base, a negation variant, and a wh-clefts variant.
...
def run():
    ...
    for i, row in merged.iterrows():
        ...
        user_prompt = build_user_prompt(base_str, neg_str, wh_str, fewshots_text)
