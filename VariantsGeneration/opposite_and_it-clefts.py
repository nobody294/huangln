...
output_csv_path    = "data/combine_opposite_it-clefts_variants.csv"

model_name = "Qwen/Qwen3-8B"

SYSTEM_PROMPT = (
    "You are a controlled text rewriter for logical variants of short English statements. "
    "You will be given a BASE statement, its OPPOSITE variant, and its IT-CLEFTS variant. "
...
BUILTIN_FEWSHOTS = [
    {
        ...
        "combine variant": "It is weaker financial support that the state should provide to unemployed workers.",
    },
    {
        ...
        "combine variant": "It is member states that violate the EU deficit rules that the EU should rigorously reward.",
    },
    {
        ...
        "combine variant": "It is bank and stock market gains that should be taxed less heavily.",
    },
    {
        ...
        "combine variant": "It is a vote for a party or candidate from any other Member State that EU citizens should be forbidden to cast in European Parliament elections.",
    },
    {
        ...
        "combine variant": "It is the legalisation of same sex marriages that is a bad thing.",
    },
    {
        ...
        "combine variant": "It is the legalisation of the personal use of soft drugs that is to be condemned.",
    },
]
...
def build_user_prompt(base: str, opp: str, it: str, fewshots_text: str) -> str:
    schema = """{
    ...
    return f"""Task: Construct a COMBINE variant from a base, a opposite variant, and an it-clefts variant.
...
def run():
    ...
    for i, row in merged.iterrows():
        ...
        user_prompt = build_user_prompt(base_str, opp_str, it_str, fewshots_text)
