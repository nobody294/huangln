...
BUILTIN_FEWSHOTS = [
    {
        ...
        "variant": "It is stronger financial support that the state should provide to unemployed workers.",
    },
    {
        "base": "The EU should rigorously punish Member States that violate the EU deficit rules.",
        "variant": "It is member states that violate the EU deficit rules that the EU should rigorously punish.",
    },
    {
        "base": "Bank and stock market gains should be taxed more heavily.",
        "variant": "It is bank and stock market gains that should be taxed more heavily.",
    },
    {
